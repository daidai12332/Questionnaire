<template>
    <div class="header">
        ...
        <div class="select1">
            ...
            <div class="shortAnswer" v-show="this.textShow">
                <h1>{{ this.questionNameList3[this.quId-this.questionNameList.length-1] }}</h1>
                <h1 v-for="item in this.answers">{{ item }}</h1>
            </div>
        
        <RouterLink class="routeItem" to="/" style="text-decoration: none; color: inherit"><span class="material-symbols-outlined">arrow_back</span></RouterLink>
        <v-chart class="chart" :option="this.option" autoresize v-show="this.isShow" />
